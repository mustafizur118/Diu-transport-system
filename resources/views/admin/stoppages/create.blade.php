...
@section('title', 'Create Bus_Stoppages')
@section('content')
    <!-- Page-Title -->
    <div class="row">
        <div class="col-sm-12">
            <div class="page-header-title">
                <h4 class="pull-left page-title">Create New Bus_Stoppages</h4>
        ...
        <div class="col-sm-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="{{route('stoppages.store')}}" method="post" >
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input value="{{old('name')}}" name="name" type="text" id="name" class="form-control" placeholder="Bus stoppages name">
                                @error('name')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
