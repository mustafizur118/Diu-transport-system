    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-header-title">
                <h4 class="pull-left page-title">List Of Bus Stoppages</h4>
        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Bus Stoppages List</h3>
                </div>
                <div class="panel-body">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered text-center">
                        ...
                        <tr>
                            ...
                            <th class="text-center" >Bus Stoppages Name</th>
                        ...
                        <tbody>
                        @foreach($stoppagess as $stoppages)
                            <tr>
                                <td>{{$serial++ }}</td>
                                <td>{{$stoppages->route->route_name}}</td>
                                <td>{{$stoppages->name}}</td>
                                <td>{{ucfirst($stoppages->status)}}</td>
                                <td class="d-flex">
                                    <a class="btn btn-info d-inline-block" href="{{ route('stoppages.edit', $stoppages->id) }}">Edit</a>
                                    <form class="d-inline-block pull-right" method="post" action="{{ route('stoppages.destroy', $stoppages->id) }}">
                                        @csrf
                                        @method('delete')
