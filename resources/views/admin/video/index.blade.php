    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-header-title">
                <h4 class="pull-left page-title">List Of Video</h4>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div style="max-width: 70px; max-height:70px;overflow:hidden">
                                        <img src="{{ asset($video->image) }}" class="img-fluid img-rounded" alt="">
                                    </div>
                                </td>
                                <td class="d-flex">
                                    <a class="btn btn-info d-inline-block" href="{{ route('video.edit', $video->id) }}">Edit</a>
                                    <form class="d-inline-block pull-right" method="post" action="{{ route('video.destroy', $video->id) }}">
                                        @csrf
                                        @method('delete')
